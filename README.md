...
> This is a fork of [Zhan's original project](https://github.com/hurshi/dio-http-cache).
...
```yaml
dependencies:
  git: https://github.com/BelityApp/dio-http-cache
```
...
```
Copyright 2025 Belity App, originally by Hurshi
